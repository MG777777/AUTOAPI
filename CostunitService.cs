...
namespace AUTOAPI
{
    public class CostunitService
    {
        ...
        public CostunitService(ILogger log, Microsoft.Azure.WebJobs.ExecutionContext context)
        {
        ...
        public async Task<List<HostCostUnit>> GetAllCostUnits()
        {
            ...
            var costUnits = await HostCompanyApi.GetAllAsync<HostCostUnit>(apiConfig.CostUnitsUrl);
            return costUnits ?? new List<HostCostUnit>();
        }
    }
}